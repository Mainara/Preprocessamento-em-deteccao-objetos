...
class DetectorObjetos:
    ...
    def getArgs(self):
        ...
        argp.add_argument("-i", "--imagens", required=True,
                          help="caminho para as imagens de entrada")
        argp.add_argument("-p", "--prototxt", required=True,
                          help="caminho para Caffe 'deploy' prototxt file")
        argp.add_argument("-m", "--model", required=True,
                          help="caminho para o modelo Caffe pre-treinado")
        argp.add_argument("-c", "--confidence", type=float, default=0.2,
    ...
    def carregaImagens(self, net):
        ...
        for img in imagens:
            ...
            blob = cv2.dnn.blobFromImage(cv2.resize(
                imagem, (300, 300)), 0.007843, (300, 300), 127.5)
